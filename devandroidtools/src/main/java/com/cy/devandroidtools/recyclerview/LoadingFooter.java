...
import com.cy.devandroidtools.recyclerview.interfaces.ILoadMoreFooter;
...
public class LoadingFooter extends RelativeLayout implements ILoadMoreFooter {
    ...
    private int hintColor = android.R.color.holo_orange_light;
    ...
    public void init(Context context) {
        ...
        indicatorColor = ContextCompat.getColor(getContext(), android.R.color.holo_orange_light);
    ...
    public void setState(State status, boolean showView) {
        ...
        switch (status) {
            ...
            case Loading:
                ...
                mLoadingText.setText(TextUtils.isEmpty(loadingHint) ? "正在加载中..." : loadingHint);
            ...
            case NoMore:
                ...
                mNoMoreText.setText(TextUtils.isEmpty(noMoreHint) ? "已全部加载完" : noMoreHint);
