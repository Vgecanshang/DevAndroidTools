...
public class LRecyclerView extends RecyclerView {
	 private boolean mPullRefreshEnabled = true;
	    ...
	    private RvListRefreshManager.UserRefreshListener userRefreshListener;
...
//	                }
	                ...
	                if (isOnTop() && mPullRefreshEnabled && !mRefreshing/*&& appbarState == AppBarStateChangeListener.State.EXPANDED*/) {
	                    if (mRefreshHeader.onRelease()) {
							if(userRefreshListener != null){
								//用户手动触发下拉刷新
								userRefreshListener.onUserRefresh();
							}
	    ...
	    public void setUserRefreshListener(RvListRefreshManager.UserRefreshListener listener){
	    	userRefreshListener = listener;
		}
